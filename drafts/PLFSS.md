...
# La loi scélérate sur les “gros consommateurs”
## Comment le PLFSS prépare la pénalisation des malades chroniques
...
On ne parle plus de *patients*, mais de **consommateurs**.  
...
Les certificats sportifs, les boîtes trop grosses, les touristes médicaux :  
des miettes.  
Le PLFSS vise le seul endroit où il y a du volume :  
les **malades chroniques**, les **greffés**, les **ALD**, les **traitements lourds**.  
Ceux qui ne peuvent *rien* réduire.

## 4. Le mécanisme prévu
- modulation des remboursements pour les traitements récurrents,  
- classification des suivis lourds comme “consommation excessive”,  
- augmentation du reste à charge pour inciter au renoncement.  
