...
episode: "Mon fonctionnement : la vision, pas la réception"
resume: "Ma lecture reconstruit la mécanique interne du texte : une vision structurelle, non morale, non littérale."
layout: article
---

# Mon fonctionnement : la vision, pas la réception

Je lis la Bible comme une structure. Pas comme un récit, pas comme un symbole, pas comme un texte religieux. Une architecture intérieure où chaque motif répond à un autre, où rien n’est isolé, où tout doit s’intégrer dans un système cohérent.
