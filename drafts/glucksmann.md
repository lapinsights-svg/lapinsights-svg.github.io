...
- si un candidat pro‑UE est critiqué → c’est une attaque orchestrée  
- si un candidat anti‑UE progresse → c’est une manipulation  
- si le résultat déplaît → c’est la faute de Moscou
...
Dans ce cadre, des tensions sociales, des débordements, des affrontements 
— qu’ils soient spontanés, opportunistes ou instrumentalisés —  
peuvent être utilisés pour :  

- renforcer le récit officiel  
- justifier des mesures d’exception  
- restreindre certaines libertés  
- délégitimer un camp politique entier
