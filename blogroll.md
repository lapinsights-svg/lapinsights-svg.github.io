...
<section class="blogroll">
  ...
  <p>
    ...
    Des lieux où la lumière se dépose autrement,  
  ...
  <ul>
    ...
    <li><a href="https://indieweb.org">IndieWeb</a> — gestes d’indépendance numérique et d’autonomie.</li>
    <li><a href="https://wiby.me">Wiby</a> — moteur dédié aux petites voix du web.</li>
    <li><a href="https://neocities.org/browse">Neocities</a> — pages personnelles, expérimentales, vivantes.</li>
    <li><a href="https://smol.pub">Smol.pub</a> — micro‑blogs minimalistes, écriture pure.</li>
    <li><a href="https://bearblog.dev/discover">Bear Blog</a> — blogs sobres, sans scripts, sans bruit.</li>
  </ul>
</section>
